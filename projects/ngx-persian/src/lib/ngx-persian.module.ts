...
import { ExperimentalPipePipe } from './Pipes/experimental-pipe.pipe';
@NgModule({
  declarations: [PersianLetterDirective, PersianNumbersDirective, FaNumPipe, EnNumPipe, IRCurrencyPipe, NationalCodePipe, JdatePipe, ExperimentalPipePipe],
  imports: [],
