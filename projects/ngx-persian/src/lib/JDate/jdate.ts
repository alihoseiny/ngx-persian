...
export class JDate implements Date {
    ...
    constructor(
        ...
        if (!jYear) {
            ...
            this._gregorianDate = this._calculator.convertToGeorgian(jYear as number, jMonth as number, jDay as number);
            this._jalaliYear = jYear as number;
            this._jMonth = jMonth;
            this._jDay = jDay;
            this._gregorianDate.setHours(hours, minutes, seconds, milliseconds);
            this._gregorianDate = JDate.changeTimeZone(this._gregorianDate, timezone);
        }
    ...
    [Symbol.toPrimitive](hint: 'default' | 'string' | 'number' | string): string | number | undefined {              // eslint-disable-line no-unused-vars
        return undefined;
    }
    ...
    toLocaleDateString(locales?: string | string[], options?: Intl.DateTimeFormatOptions): string {              // eslint-disable-line no-dupe-class-members
        if (!this._gregorianDate) {
            throw InvalidJalaliDateError;
        }
    ...
    toLocaleTimeString(locales?: string | string[], options?: Intl.DateTimeFormatOptions): string {              // eslint-disable-line no-dupe-class-members
        if (!this._gregorianDate) {
            throw InvalidJalaliDateError;
        }
